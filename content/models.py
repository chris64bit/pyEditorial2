...
class Blog(models.Model):
    ...
    thumbnail = models.ImageField(upload_to='content/blog/thumbnail/', verbose_name="Thumbnail :", blank=True, null=True)
...
class Faq(models.Model):
    title = models.CharField(max_length=256, verbose_name="Title :", unique=True, null=False, blank=False)
    faq = models.CharField(max_length=256, verbose_name="FAQ :", unique=True, null=False, blank=False)
